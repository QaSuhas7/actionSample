...
public class TestRenewProfessional_CES extends BaseClass {
	...
	public void ValidateRenewProfessional() throws Throwable {
		String prefix = "Dr.";
		String suffix = "Sr.";
		...
		/*
		 * String paId = apiValidation.getProviderApplicationID(userAccount.get(0) + " "
		 * + userAccount.get(1));
		 * 
		 * // Navigate to Fonteva app. FontevaConnectionSOAP sessionID = new
		 * FontevaConnectionSOAP(); final String sID = sessionID.getSessionID();
		 */
...
//		fontevaPage.changeTermDates(dataList.get(0)+" "+dataList.get(1));
		termDateChangeAPICall.changeTermDateAPI(dataList.get(3), "2024-12-31","CES Professional");
