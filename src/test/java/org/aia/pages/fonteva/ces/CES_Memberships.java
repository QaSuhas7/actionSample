...
//	@FindBy(xpath = "(//*[@role = 'table']//tbody//tr//td)[6]//a")
	@FindBy(xpath = "(//table[@aria-label = 'Memberships']//tbody//tr//td)[6]//a")
...
//		driver.findElement(By.xpath( "//div[@class='uiVirtualDataTable indicator']/following-sibling::table/tbody//a[text()='" + fullName + "']")).click();
