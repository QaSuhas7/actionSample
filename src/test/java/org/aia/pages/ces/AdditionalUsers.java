...
public class AdditionalUsers {
	...
	public void addAdditionalUsers(ArrayList<String> dataList) {
		...
		js.executeScript("arguments[0].click();", additionalNext);
	...
	public void doneWithCreatingUsers() throws Exception {
		...
		Thread.sleep(2000);
		util.clickUsingJS(driver, doneCreatingUsers);
//		doneCreatingUsers.click();
		util.clickUsingJS(driver, additionalNext);
//		additionalNext.click();
	}
	...
	public void verifyAUTab() throws InterruptedException {
		Thread.sleep(10000);
