...
public class SignUpPageCes {
	...
	@FindBy(css  = "mat-select[formcontrolname='mobilePhoneCountry']")
	WebElement mobileCountry;
	...
	public void signUpUser() throws Exception {
		...
		Utility.retryElement(3, driver, mobileCountryoption, 5000, mobileCountry);
	...
	public String signUpUserDetail() throws Exception {
		...
		lastName.sendKeys(lName);
		emailAddress.sendKeys(emailaddressdata);
		js.executeScript("arguments[0].click();", mobileCountry);
		Thread.sleep(2000L);
		Utility.retryElement(4, driver, mobileCountryoption, 2000, mobileCountry);
		Thread.sleep(1000);
